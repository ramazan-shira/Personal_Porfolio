...
const Cards = (props) => {
  ...
  return (
    <div className="about-cards-container">
      <div className={darkMode ? "about-card bg-1 dark" : "about-card bg-1"}>
        <div className="about-card-image">
          <img src={web} alt="Web development" />
        </div>
        <div
          className={
            darkMode ? "about-card-content dark" : "about-card-content"
          }
        >
      ...
      <div className={darkMode ? "about-card bg-2 dark" : "about-card bg-2"}>
        <div className="about-card-image">
